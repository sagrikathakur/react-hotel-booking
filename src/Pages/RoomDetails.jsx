...
<label htmlFor="Guest" className='font-medium'> Check-In</label>
...
<div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
  <p>
Guests will be allocated on the ground floor, ensuring easy access and convenience without the need to climb stairs.  
You will enjoy a spacious and comfortable 2-bedroom apartment, thoughtfully designed to provide a home-like atmosphere.  
Each bedroom is well-ventilated and furnished to meet the needs of both short and extended stays.  
The living area is perfect for relaxing after a long day, with ample space for work or entertainment.  
Located in a quiet and secure neighborhood, the apartment also offers proximity to local shops, restaurants, and public transport.
</p>
